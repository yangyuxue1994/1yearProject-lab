...
jsPsych.plugins['categorize-image-asp'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('categorize-image-asp', 'stimulus', 'image');

  plugin.info = {
    name: 'categorize-image-asp',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.sentence_stimuli !== null) {
      ...
      display_element.querySelector('.prime_sentence').style.visibility = 'hidden'; // hide
    }

    // hide typing effect after time if the timing parameter is set
    // var wipeout_time = Math.floor(Math.random() * ((500-300)+1) + 500);
    jsPsych.pluginAPI.setTimeout(function() {
        display_element.querySelector('#typing_prompt').style.visibility = 'hidden';
        display_element.querySelector('#typing').style.visibility = 'hidden';
        display_element.querySelector('#prime_sentence').style.visibility = 'visible'; // hide        

        // allow to press the key:
